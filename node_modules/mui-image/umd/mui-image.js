/*!
 * mui-image v1.0.4 - https://mui-image.surge.sh/
 * ISC Licensed
 */
...
var emotion_element_99289b21_browser_esm_getTheme = function getTheme(outerTheme, theme) {
  ...
  return esm_extends_extends({}, outerTheme, theme);
};
...
function withTheme(Component) {
  ...
  var render = function render(props, ref) {
    var theme = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useContext"])(ThemeContext);
    return /*#__PURE__*/Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(Component, esm_extends_extends({
      theme: theme,
      ref: ref
    }, props));
  }; // $FlowFixMe
...
// CONCATENATED MODULE: ./node_modules/@mui/material/node_modules/@babel/runtime/helpers/esm/extends.js
...
function createMixins(breakpoints, spacing, mixins) {
  return runtime_helpers_esm_extends_extends({
    toolbar: {
      minHeight: 56,
...
function createPalette(palette) {
  ...
  const augmentColor = ({
    ...
    color = runtime_helpers_esm_extends_extends({}, color);
  ...
  const paletteOutput = deepmerge(runtime_helpers_esm_extends_extends({
...
function createTypography(palette, typography) {
  ...
  const buildVariant = (fontWeight, size, lineHeight, letterSpacing, casing) => runtime_helpers_esm_extends_extends({
    fontFamily,
    fontWeight,
  ...
  return deepmerge(runtime_helpers_esm_extends_extends({
    htmlFontSize,
    pxToRem,
    fontFamily,
    fontSize,
...
function createTransitions(inputTransitions) {
  const mergedEasing = runtime_helpers_esm_extends_extends({}, createTransitions_easing, inputTransitions.easing);

  const mergedDuration = runtime_helpers_esm_extends_extends({}, createTransitions_duration, inputTransitions.duration);
...
function styles_createTheme_createTheme(options = {}, ...args) {
  ...
  let muiTheme = deepmerge(systemTheme, {
    ...
    zIndex: runtime_helpers_esm_extends_extends({}, styles_zIndex)
  });
...
const SvgIcon_SvgIcon = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_["forwardRef"](function SvgIcon(inProps, ref) {
  ...
  const ownerState = runtime_helpers_esm_extends_extends({}, props, {
    color,
    component,
    fontSize,
    viewBox
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsxs"])(SvgIconRoot, runtime_helpers_esm_extends_extends({
    as: component,
...
function createSvgIcon(path, displayName) {
  const Component = (props, ref) => /*#__PURE__*/Object(jsx_runtime["jsx"])(material_SvgIcon_SvgIcon, runtime_helpers_esm_extends_extends({
...
// EXTERNAL MODULE: ./node_modules/@emotion/react/node_modules/@babel/runtime/helpers/extends.js
var runtime_helpers_extends = __webpack_require__(17);
...
const CircularProgress_CircularProgress = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_["forwardRef"](function CircularProgress(inProps, ref) {
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(CircularProgressRoot, runtime_helpers_esm_extends_extends({
    className: clsx_m(classes.root, className),
